 ...
 * Real brand logos in monochrome. Placed right below the Hero section.
 */
...
const tools = [
  {
    name: "Cursor",
    logo: (
      <svg viewBox="0 0 466.73 532.09" className="h-7 w-7" fill="currentColor">
  ...
  },
  {
    name: "Windsurf",
    logo: (
      <svg viewBox="0 0 24 24" className="h-7 w-7" fill="currentColor" fillRule="evenodd">
