    ...
    <div className="flex min-h-svh justify-center px-4 py-12">
      <div className="w-full max-w-2xl">
        ...
        <article className="prose prose-sm prose-neutral max-w-none [&_h1]:text-2xl [&_h1]:font-semibold [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:mt-10 [&_h2]:mb-4 [&_h3]:text-base [&_h3]:font-semibold [&_h3]:mt-8 [&_h3]:mb-3 [&_p]:text-sm [&_p]:leading-relaxed [&_p]:text-muted-foreground [&_li]:text-sm [&_li]:text-muted-foreground [&_strong]:text-foreground">
          ...
          <p>
            Your privacy is important to us. It is Space Cadet d.o.o.&apos;s
            ...
            <a href="https://mockhero.dev">https://mockhero.dev</a>, and other
          ...
          <p>This policy is effective as of March 22, 2026.</p>
          ...
          <p>
            We may ask for personal information &mdash; for example, when you
            register an account or when you contact us &mdash; which may include
          ...
          <p>
            When you use the MockHero API, we collect usage data including: the
            number of API requests made, the endpoints accessed, request
            timestamps, response times, error rates, and the volume of data
            generated. This data is associated with your API key and account. We
            use this information to enforce rate limits, monitor service health,
            prevent abuse, and improve our service.
          </p>

          <h3>User-Generated Content</h3>
          <p>
            We consider &ldquo;user-generated content&rdquo; to be materials
            (text, schemas, and configurations) voluntarily supplied to us by
            our users for the purpose of generating synthetic data through our
            API. This includes table schemas, field definitions, and prompt
            descriptions submitted to our data generation endpoints.
          </p>
          <p>
            We do not store the generated output data beyond the duration of the
            API response. Schemas submitted via the API may be logged
            temporarily for debugging and abuse prevention purposes.
          </p>
          ...
          <ul>
            ...
            <li>Create or manage API keys</li>
          ...
          <ul>
            ...
            <li>
              to authenticate API requests and enforce usage limits
            </li>
            <li>to contact and communicate with you</li>
            <li>
              to send you service-related notifications, including usage
              alerts, billing confirmations, and API status updates
            </li>
            <li>
              to enable you to access and use our website, API, and associated
              applications
            </li>
            <li>
            ...
            <li>
              ...
              and apps are safe, secure, and used in line with our{" "}
          ...
          <p>
            API keys are stored as cryptographic hashes (SHA-256). The raw key
            is shown only once at creation time and is never stored or
            recoverable by us. You are responsible for safeguarding your API
            keys and ensuring they are not exposed in public repositories,
            client-side code, or shared environments.
          </p>
          ...
          <p>
            ...
            for, in accordance with this privacy policy. Specific retention
            periods are as follows:
          </p>
          <ul>
            <li>
              <strong>Account data</strong> (name, email, settings): retained
              for the duration of your account plus 30 days after account
              deletion.
            </li>
            <li>
              <strong>Billing and financial records</strong>: retained for 7
              years as required by Croatian and EU accounting law.
            </li>
            <li>
              <strong>API usage logs</strong>: retained for 90 days.
            </li>
            <li>
          ...
          <p>
            If your personal information is no longer required for these
            purposes, we will delete it or make it anonymous by removing all
          ...
          <ul>
            <li>
              <strong>Supabase</strong> &mdash; database hosting (AWS,
              eu-central-1)
            </li>
            <li>
            ...
            <li>
              <strong>Polar</strong> &mdash; payment processing and
              subscription management
            </li>
            <li>
              <strong>Brevo</strong> &mdash; transactional email
            </li>
            <li>
              <strong>Datafast</strong> &mdash; analytics
            </li>
            <li>
              <strong>CookieBot</strong> &mdash; cookie consent management
            </li>
          </ul>
          ...
          <p>
            ...
            the European Union (Germany, Ireland) and the United States of
            America, or where we or our partners, affiliates, and third-party
          ...
          <p>
            ...
            receiving communications from us, including marketing and
            promotional messages, at any time. To do so, use the opt-out
            facilities provided in the communication. For example, you can click
            the &ldquo;unsubscribe&rdquo; link included in any marketing email
            we send you, visit{" "}
            <a href="https://mockhero.dev">https://mockhero.dev</a>, or contact
            us directly using the contact information provided in this privacy
          ...
          <p>
            ...
            service inquiries, or providing important updates related to your
            use of our services.
          </p>
          ...
          <p>
            ...
            management, as well as analytics cookies to understand how visitors
            use our site. You can manage your cookie preferences at any time
            through our cookie consent banner powered by CookieBot.
          </p>
          ...
          <h3>California Privacy Laws &mdash; CPPA</h3>
          <p>
          ...
          <ul>
            <li>
              Identifiers, such as name, email address, account name, IP
              address, and an ID or number assigned to your account.
            </li>
            <li>
              Commercial information, such as subscription history and API
              usage records.
            </li>
            <li>
              Internet activity, such as your interactions with our service and
          ...
          <p>
            ...
            &ldquo;Privacy Rights Request&rdquo; in the first line of the
          ...
          <p>
            ...
            processors&rdquo;). We, Space Cadet d.o.o., located at the address
          ...
          <p>
            ...
            guardian&apos;s consent to process your personal information for
          ...
          <p>
            ...
            contract or transaction with you. For example, if you subscribe to a
            paid plan, we require your email and payment information to fulfill
            the subscription.
          </p>
          ...
          <p>
            ...
            restrict the processing of your personal information if: you are
            concerned about the accuracy of your personal information; you
            believe your personal information has been unlawfully processed; you
            need us to maintain the personal information solely for the purpose
            of a legal claim; or we are in the process of considering your
          ...
          <p>
            ...
            30 days of the deletion of your account. Please be aware that
          ...
          <p>
            ...
            you sign up using a third-party authentication provider (such as
            Google or GitHub), we receive your name and email address from that
          ...
          <p>
            ...
            identify you (&ldquo;Anonymisation&rdquo;). However, if necessary,
          ...
          <p>
            ...
            transparent manner. We never directly market to any person(s) under
            18 years of age.
          </p>
          <p>
            Our lawful bases depend on the services you use and how you use
          ...
          <p>
            ...
            order to take preparatory steps prior to our entering into a
            contract or transaction with you. For example, if you subscribe to a
            paid plan, we require personal information such as your email and
            payment details in order to process the subscription.
          </p>
          ...
          <p>
            ...
            personal information. Such cases may include (but are not limited
            to) court orders, criminal investigations, government requests, and
            regulatory obligations. For example, we are required to keep
            financial records for a period of 7 years. If you have any further
          ...
          <p>
            ...
            Commission, the UK has been granted an essentially equivalent level
            of protection to that guaranteed under UK GDPR.
          </p>
          <p>
            On some occasions, where we share your data with third parties, they
            may be based outside of the UK, or the European Economic Area
            (&ldquo;EEA&rdquo;). These countries to which we store, process, or
          ...
          <p>
            ...
            information solely for the purpose of a legal claim; or (iv) we are
            in the process of considering your objection in relation to
          ...
          <p>
            ...
            deadline for fulfilling a DSAR request is 30 calendar days from our
          ...
          <ul>
            ...
            <li>
              ...
              that consent has been withdrawn. Space Cadet d.o.o. relies on
              consent to process personal data in very few circumstances.
            </li>
            <li>
              The Company is relying on legitimate interests as a legal basis
              for processing personal data and an individual has exercised the
              right to object and it has been determined that the Company has no
          ...
          <p>
            ...
            get some of their personal data from an organisation in a way that
            is accessible and machine-readable, for example as a CSV file.
            Associated with this, individuals also have the right to ask an
            organisation to transfer their personal data to another
            organisation.
          </p>
          ...
          <ul>
            <li>
              ...
              Space Cadet d.o.o. in electronic form; and
            </li>
            <li>
          ...
          <p>
            ...
            inaccurate, out of date, or incomplete, individuals have the right
            to correct, update or complete that data. Collectively this is
            referred to as the right to rectification. Rectification may involve
            filling the gaps i.e. to have incomplete personal data completed
            &mdash; although this will depend on the purposes for the
            processing. This may involve adding a supplementary statement to the
          ...
          <p>
            ...
            UK&apos;s data protection regulator and yourself, if we deem it
          ...
          <p>
            ...
            in the first instance using the details below. Please provide us
            with as much information as you can about the alleged breach. We
            ...
            we will take to deal with your complaint.
          </p>

          <h3>Enquiries, Reports and Escalation</h3>
          <p>
            To enquire about Space Cadet d.o.o.&apos;s privacy policy, or to
          ...
          <p>
            ...
            also contact the Information Commissioner&apos;s Office (ICO), the
